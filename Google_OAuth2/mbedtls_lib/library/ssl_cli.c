...
int mbedtls_ssl_handshake_client_step( mbedtls_ssl_context *ssl )
{
	...
	printf("1(->).	MBEDTLS_SSL_CLIENT_HELLO\n\n");
	#endif
	...
	#ifdef handshake_debug
	   	printf("2(<-).	MBEDTLS_SSL_SERVER_HELLO\n\n");
	#endif
	...
	#ifdef handshake_debug
	   	printf("3(<-).	MBEDTLS_SSL_SERVER_CERTIFICATE\n\n");
	#endif
	...
	#ifdef handshake_debug
	   	printf("3(<-).	MBEDTLS_SSL_SERVER_KEY_EXCHANGE\n\n");
	#endif
	...
	#ifdef handshake_debug
	   	printf("3(<-).	MBEDTLS_SSL_CERTIFICATE_REQUEST\n\n");
	#endif
	...
	#ifdef handshake_debug
	   	printf("4(<-).	MBEDTLS_SSL_SERVER_HELLO_DONE\n\n");
	#endif
	...
	#ifdef handshake_debug
	   	printf("5(->).	MBEDTLS_SSL_CLIENT_CERTIFICATE\n\n");
	#endif
	...
	#ifdef handshake_debug
	   	printf("5(->).	MBEDTLS_SSL_CLIENT_KEY_EXCHANGE\n\n");
	#endif
	...
	#ifdef handshake_debug
	   	printf("5(->).	MBEDTLS_SSL_CERTIFICATE_VERIFY\n\n");
	#endif
	...
	#ifdef handshake_debug
	   	printf("6(->).	MBEDTLS_SSL_CLIENT_CHANGE_CIPHER_SPEC\n\n");
	#endif
	...
	#ifdef handshake_debug
	   	printf("7(->).	MBEDTLS_SSL_CLIENT_FINISHED\n\n");
	#endif
	...
	#ifdef handshake_debug
	   	printf("13.	MBEDTLS_SSL_SERVER_NEW_SESSION_TICKET\n\n");
	#endif
	...
	#ifdef handshake_debug
	   	printf("8(<-).	MBEDTLS_SSL_SERVER_CHANGE_CIPHER_SPEC\n\n");
	#endif
	...
	#ifdef handshake_debug
	   		printf("9(<-).	MBEDTLS_SSL_SERVER_FINISHED\n\n");
	#endif
	...
	#ifdef handshake_debug
	   	printf("16.	MBEDTLS_SSL_FLUSH_BUFFERS\n\n");
	#endif
	...
	#ifdef handshake_debug
	   	printf("17.	MBEDTLS_SSL_HANDSHAKE_WRAPUP\n\n");
	#endif
