...
//	John.Yeh@cyberpower.com
//	Topic >> MeetingRoomLight

#define AWS_IOT_MQTT_HOST				"iot.cyberpower.com" ///< Customer specific MQTT HOST. The same will be used for Thing Shadow
#define MQTT_BROKER_NAME				"cps" 
#define MQTT_BROKER_PASSWORD			"0ee63eca75f887bca71abd7754a3848e"

#define AWS_IOT_MQTT_PORT				1883 ///< default port for MQTT/S

#define ROOT_CA_FILENAME		"./cert/rootCA.crt"			//< Root CA file name
#define CERTIFICATE_FILENAME		"./cert/cert.pem"			//< device signed certificate file name
#define PRIVATE_KEY_FILENAME	"./cert/privkey.pem"			//< Device private key filename
// =================================================
